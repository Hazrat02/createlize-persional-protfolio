      ...
      <div class="row justify-content-between align-items-center hero">
        ...
        <div class="col-md-6 mb-md-0 mb-5">
          ...
          <div class="container">
            <a
              target="_blank"
              href="https://github.com/Hazrat02"
              class="btn btn-outline-one icon-space-left"
              >See Github <i class="fa-brands fa-github"></i>
            </a>
          </div>
        </div>
        <div class="col-md-6">
      ...
      <div class="hero__footer">
        <div class="hero__footer-left">
          <div class="hero__footer-left-arrow">
            <img
              src="https://andreagandolfo.it/images/hero/arrow.svg"
              alt="Icon"
            />
          </div>
    ...
    <section class="mt-5">
      <div class="image-full">
        <div class="image-full__scroll">
          <img src="./../assets/frontend/img/my-img-4.png" alt="Image" />
        </div>
        <div class="image-full__circle">
          <a href="contact.html">
            <img
              class="image-circle"
              src="https://andreagandolfo.it/images/circle-text.jpg"
              alt="Circle"
            />
            <img
              class="image-avatar"
              src="https://andreagandolfo.it/images/avatar.png"
              alt="Avatar"
            />
          </a>
        </div>
